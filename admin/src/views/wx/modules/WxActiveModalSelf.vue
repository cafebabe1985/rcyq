    ...
    <a-spin :spinning="confirmLoading">
      ...
      <a-form :form="form">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="活动主题" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="[ 'name', validatorRules.name]" placeholder="请输入活动名称"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="活动详情" :labelCol="labelCol" :wrapperCol="wrapperCol">
...
<a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="活动封面" :labelCol="labelCol" :wrapperCol="wrapperCol">
          ...
          <a-col :span="24">
            <a-form-item label="活动保险" :labelCol="labelCol" :wrapperCol="wrapperCol">
